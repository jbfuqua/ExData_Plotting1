...
plot(range$Time, range$Global_active_power, xlab="",ylab="Global Active Power", type="l")


# second 

plot(range$Time, range$Voltage, xlab="datetime",ylab="Voltage", type="l")
...
plot(range$Time, range$Global_reactive_power, xlab="datetime",ylab="Global_reactive_power", type="l")
